...
#define CLOCK_H									32UL
#define CLOCK_F									64UL
#define CLOCK_G									128UL

//------------------------------------------------------------------------------
#define GPIO_CLOCK_ON(PORT) \
		{ RCC->AHBENR |= (CLOCK_##PORT);}
...
#define MOTOR_DIRECT			B, 15, 	LOW, MODE_OUTPUT_PUSH_PULL, SPEED_400KHZ, AF_NO
#define MOTOR_PWM		B, 15, 	LOW, MODE_AF_PUSH_PULL_PULL_UP, SPEED_400KHZ, 	AF3
*/
